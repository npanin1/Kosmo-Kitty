...
public class WeaponManager : MonoBehaviour
{
    ...
    public static void Add(Weapon weapon, int patrons, int flag)
    {
        if (flag == 1) _inst.Add_inst(weapon, patrons);
        if (flag == 2) foot.PlayStep(Footsteps.StepsOn.TakePatron, 1);
    }
